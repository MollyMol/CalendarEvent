...
namespace CalendarForm {
    ...
    public partial class CalendarDataSet : global::System.Data.DataSet {
        ...
        public partial class EventsDataTable : global::System.Data.TypedTableBase<EventsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EventsRow AddEventsRow(System.DateTime Date, string Customer, string Address, string Comment) {
        ...
        public partial class EventsRow : global::System.Data.DataRow {
            ...
            public string Customer {
                get {
                    return ((string)(this[this.tableEvents.CustomerColumn]));
                }
                set {
                    this[this.tableEvents.CustomerColumn] = value;
                }
            }
            ...
            public string Comment {
                get {
                    return ((string)(this[this.tableEvents.CommentColumn]));
                }
                set {
                    this[this.tableEvents.CommentColumn] = value;
                }
            }
        }
...
namespace CalendarForm.CalendarDataSetTableAdapters {
    ...
    public partial class EventsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Events] WHERE (([Id] = @Original_Id) AND ([Date] = @Original_D" +
                "ate) AND ([Customer] = @Original_Customer) AND ([Address] = @Original_Address) A" +
                "ND ([Comment] = @Original_Comment))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Events] ([Date], [Customer], [Address], [Comment]) VALUES (@Da" +
                "te, @Customer, @Address, @Comment);\r\nSELECT Id, Date, Customer, Address, Comment" +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Events] SET [Date] = @Date, [Customer] = @Customer, [Address] = @Address, [Comment] = @Comment WHERE (([Id] = @Original_Id) AND ([Date] = @Original_Date) AND ([Customer] = @Original_Customer) AND ([Address] = @Original_Address) AND ([Comment] = @Original_Comment));
SELECT Id, Date, Customer, Address, Comment FROM Events WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CalendarForm.Properties.Settings.Default.CalendarConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Date, Customer, Address, Comment FROM dbo.Events";
        ...
        public virtual int Delete(int Original_Id, System.DateTime Original_Date, string Original_Customer, string Original_Address, string Original_Comment) {
        ...
        public virtual int Insert(System.DateTime Date, string Customer, string Address, string Comment) {
        ...
        public virtual int Update(System.DateTime Date, string Customer, string Address, string Comment, int Original_Id, System.DateTime Original_Date, string Original_Customer, string Original_Address, string Original_Comment, int Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(System.DateTime Date, string Customer, string Address, string Comment, int Original_Id, System.DateTime Original_Date, string Original_Customer, string Original_Address, string Original_Comment) {
            return this.Update(Date, Customer, Address, Comment, Original_Id, Original_Date, Original_Customer, Original_Address, Original_Comment, Original_Id);
        }
    }
